...
%
% The output tables for each timestamp store rowwise dF/F values of
% the cells (one column per cell) as well as their low-pass smoothed dF/F
...
for exp = 1:size(dat.Fcell, 2)
    ...
    %% Detect events and create output table
